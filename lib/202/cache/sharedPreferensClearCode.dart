...
class SharedPreferanceClearCodeLearn extends StatefulWidget {
  const SharedPreferanceClearCodeLearn({super.key});

  @override
  State<SharedPreferanceClearCodeLearn> createState() => _SharedPreferanceClearCodeLearnState();
}

class _SharedPreferanceClearCodeLearnState
    extends LoadingStatefull<SharedPreferanceClearCodeLearn> {
